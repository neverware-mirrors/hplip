...
STATUS_TO_ERROR_STATE_MAP = {
    ...
    EVENT_ERROR_CHANNEL_BUSY : ERROR_STATE_ERROR,
...
# 'kind'
AGENT_KIND_NONE = 0
AGENT_KIND_HEAD = 1 # InkJet
AGENT_KIND_SUPPLY = 2 # InkJet
AGENT_KIND_HEAD_AND_SUPPLY = 3 # InkJet
...
AGENT_TYPE_UNSPECIFIED = 0x3e # Used for kind = 5, 6, 7, 8, or 9
...
# fax-types
FAX_TYPE_NONE = 0
FAX_TYPE_BLACK_SEND = 1
FAX_TYPE_BLACK_AND_COLOR_SEND = 2
